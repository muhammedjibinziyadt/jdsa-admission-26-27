...
const defaultContent = {
  hero: {
    title: 'ജവഹറത്തുൽ ഉലൂം സുഫ്ഫാ ദർസ്',
  ...
  about: {
    ...
    description: 'ജവഹറത്തുൽ ഉലൂം സുഫ്ഫാ ദർസ് ഇസ്‌ലാമിക പാരമ്പര്യവും ആധുനിക വിദ്യാഭ്യാസവും സമന്വയിപ്പിച്ച് വിദ്യാർത്ഥികളെ സമഗ്രമായി വളർത്തിയെടുക്കുന്നു. മതപരമായ അറിവിനൊപ്പം പ്രായോഗിക കഴിവുകളും നേതൃത്വ ഗുണങ്ങളും വികസിപ്പിക്കാൻ ഞങ്ങൾ പ്രതിജ്ഞാബദ്ധരാണ്.',
    features: [
  ...
  contact: {
    ...
    address: 'ജവഹറത്തുൽ ഉലൂം സുഫ്ഫാ ദർസ്',
  ...
  footer: {
    copyright: '© 2024 ജവഹറത്തുൽ ഉലൂം സുഫ്ഫാ ദർസ്. എല്ലാ അവകാശങ്ങളും നിക്ഷിപ്തം.',
