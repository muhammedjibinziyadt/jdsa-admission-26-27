...
const SocialButtons = ({ 
  ...
  const socialLinks = [
    {
      name: "WhatsApp",
      url: `https://wa.me/${links.whatsapp}`,
      Icon: MessageCircle,
  ...
  return (
    <div className={`${fixed ? 'fixed bottom-6 right-6 z-50' : ''} flex flex-col gap-3`}>
      {visibleLinks.map((social) => (
        <a
          ...
          className={`${social.color} text-white p-4 rounded-full shadow-lg hover:scale-110 transition-all duration-300 flex items-center justify-center`}
