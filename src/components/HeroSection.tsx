...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-64 h-64 flowing-shape flowing-shape-1 animate-float" />
      <div className="absolute bottom-32 left-10 w-48 h-48 flowing-shape flowing-shape-2 animate-float animation-delay-400" />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <div className="animate-fade-up animation-delay-800">
          <Button 
            size="lg" 
            className="gold-bg text-primary font-semibold px-10 py-6 text-lg rounded-2xl shadow-gold hover:scale-105 transition-all duration-300"
